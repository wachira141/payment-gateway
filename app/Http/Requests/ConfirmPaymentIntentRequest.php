...
class ConfirmPaymentIntentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'payment_method.card.exp_month' => ['required_with:payment_method.card', 'integer', 'between:1,12'],
            'payment_method.card.exp_year' => ['required_with:payment_method.card', 'integer', 'min:' . date('Y')],
            ...
            'payment_method.mobile_money.phone' => ['required_with:payment_method.mobile_money', 'string'],
